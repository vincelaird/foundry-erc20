# copied from: https://github.com/Cyfrin/foundry-erc20-cu/blob/main/Makefile
# with changes to Make deploy
...
deploy:
	@forge create src/OurToken.sol:OurToken --rpc-url http://localhost:8545 --private-key $(DEFAULT_ANVIL_KEY) --constructor-args 1000000000000000000000
